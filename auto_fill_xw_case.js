(function() {
    ...
    const systemReviewData = {
        ...
        "个人生活史：": "原籍出生及居住，无外地久居史，无疫区疫水接触史，无特殊化学品及放射线接触史，无吸烟史，无饮酒史，无冶游史。",
        "婚姻史：": "已婚，配偶及子女体健",
        "月经及生育史：": "无",
        "家族史：": "无家族史",
    };
...
function fillHeartBoundaryTable(tableSelector, data) {
    ...
    // 执行填充
    fillFormSection(
        'div[data-v-588f8aa1] .el-form-item',
        '.el-form-item__label',
    ...
    fillFormSection(
        'div[data-v-2ff49afb] .el-form-item.leaf-node',
        '.el-form-item__label',
